import 'package:chain_signatures_example/modules/pages/init/widgets/near_account_create_dialog.dart';
import 'package:chain_signatures_example/modules/pages/init/widgets/near_account_import_dialog.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text(
              """Sign and Execute transactions across many blockchain protocols with \nNear Chain Signatures""",
              style: TextStyle(
                fontSize: 30.sp,
